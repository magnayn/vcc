...
public class VixConnectionProvider implements ConnectionProvider {
    ...
    private final static Pattern URL_PATTERN = Pattern.compile("vcc\\:vmware-vix\\:([^\\:\\;\\&]+)(:\\d+)?([\\;\\&].*)?");

    private final static Pattern PARAMS_PATTERN = Pattern.compile("[\\;\\&]([a-zA-Z][a-zA-Z0-9\\-\\_]*)=([^\\;\\&]+)");
